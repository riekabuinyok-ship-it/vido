...
export async function saveImage(file) {
  ...
  try {
    ...
    // Serverless (Vercel) filesystem is read-only. Don't fail the save;
    // the record is created without a logo.
    console.warn("Could not store uploaded file:", error.message);
    return null;
  }
}
